...
///        for a utility token on the DHashToken platform
/// @author DHashToken Ltd.
contract SimpleStake is ProtocolVersioned {
	...
	/// @param _DHashTokenProtocol DHashTokenProtocol contract that governs staking
	/// @param _uuid Unique Universal Identifier of the registered utility token
	function SimpleStake(
		EIP20Interface _eip20Token,
		address _DHashTokenProtocol,
		bytes32 _uuid)
		ProtocolVersioned(_DHashTokenProtocol)
		public
	{
    ...
    ///      the DHashToken protocol will not mint new utility tokens,
