...
/// @title DHashTokenValue - value staking contract for DHashToken 
/// @notice 
contract DHashTokenValue is OpsManaged, Hasher {
	...
	///      for the DHashTokenValue contract to transfer to itself to hold
		...
		bytes32 stakingIntentHash)
	{
		...
		// DHashTokenValue needs to be able to transfer the stake into its balance for
		...
		returns (bytes32 uuid)
	{
		...
		address DHashTokenRemote = cores[_chainIdUtility].DHashTokenRemote();
		require(DHashTokenRemote != address(0));
